...
class Admin(Users):
    def __init__(self, f_name, l_name, username, age):
        ...
        self.privileges = [] # creating a attribute
...
admin.privileges = ['can add user', 'can ban users'] # storing data

user1.describe_user() # calling describe method to describe user
user1.greet_user() # calling greet method to greet the user
admin.describe_user() # calling describe method to describe admin
admin.show_privileges() # calling show_privileges to print privilege
print('\n')
